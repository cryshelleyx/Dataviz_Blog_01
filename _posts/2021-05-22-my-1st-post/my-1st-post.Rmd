...
* A contrasting colour palette (blue - export, red - import) is used for the line chart. A gray colour is used for the histogram to display the net export field. Only the light gray colour is used for histogram, this is to avoid confusing the audience with too many colours on the graph.
